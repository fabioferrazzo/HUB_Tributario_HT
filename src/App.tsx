...
function ArquivosModule() {
  return (
    <section className="panel full-panel">
      <PanelHeader title="Arquivos" icon={<FileArchive size={18} />} action="Google Drive" />
      <div className="file-grid">
        ...
        <article>
          <strong>Anexos de lembretes</strong>
          <span>Storage do HUB</span>
        </article>
        <article>
          <strong>Documentos recentes</strong>
          <span>Em configuracao</span>
        </article>
      </div>
    </section>
  );
